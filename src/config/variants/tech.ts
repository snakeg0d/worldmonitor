// Tech/AI variant - tech.worldmonitor.snakeg0d.com
...
export const FEEDS: Record<string, Feed[]> = {
  ...
  security: [
    ...
    { name: 'CISA Advisories', url: 'https://rss.worldmonitor.snakeg0d.com/api/rss-proxy?url=' + encodeURIComponent('https://www.cisa.gov/cybersecurity-advisories/all.xml') },
