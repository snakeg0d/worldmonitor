...
// VITE_VARIANT=tech → tech.worldmonitor.snakeg0d.com (tech-focused)
// VITE_VARIANT=full → worldmonitor.snakeg0d.com (geopolitical)
// VITE_VARIANT=finance → finance.worldmonitor.snakeg0d.com (markets/trading)
