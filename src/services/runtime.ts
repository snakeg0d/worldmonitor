const DEFAULT_REMOTE_HOSTS: Record<string, string> = {
  tech: 'https://tech.worldmonitor.snakeg0d.com',
  full: 'https://worldmonitor.snakeg0d.com',
  world: 'https://worldmonitor.snakeg0d.com',
};
...
export function getRemoteApiBaseUrl(): string {
  ...
  return DEFAULT_REMOTE_HOSTS[variant] ?? DEFAULT_REMOTE_HOSTS.full ?? 'https://worldmonitor.snakeg0d.com';
}
...
const APP_HOSTS = new Set([
  'worldmonitor.snakeg0d.com',
  'www.worldmonitor.snakeg0d.com',
  'tech.worldmonitor.snakeg0d.com',
  'localhost',
  '127.0.0.1',
]);
...
function isAppOriginUrl(urlStr: string): boolean {
  try {
    ...
    return APP_HOSTS.has(host) || host.endsWith('.worldmonitor.snakeg0d.com');
  } catch {
    return false;
  }
}
