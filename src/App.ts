...
export class App {
  ...
  private async checkForUpdate(): Promise<void> {
    try {
      const res = await fetch('https://worldmonitor.snakeg0d.com/api/version');
      if (!res.ok) {
      ...
      const releaseUrl = typeof data.url === 'string' && data.url
        ? data.url
        : 'https://github.com/snakeg0d/worldmonitor/releases/latest';
  ...
  private async resolveUpdateDownloadUrl(releaseUrl: string): Promise<string> {
    try {
      ...
      if (platform) {
        ...
        return `https://worldmonitor.snakeg0d.com/api/download?platform=${platform}&variant=${variant}`;
      }
    } catch {
      ...
      <div class="header">
        <div class="header-left">
          <div class="variant-switcher">
            <a href="${this.isDesktopApp ? '#' : (SITE_VARIANT === 'full' ? '#' : 'https://worldmonitor.snakeg0d.com')}"
            ...
            <a href="${this.isDesktopApp ? '#' : (SITE_VARIANT === 'tech' ? '#' : 'https://tech.worldmonitor.snakeg0d.com')}"
            ...
            <span class="variant-divider"></span>
            <a href="${this.isDesktopApp ? '#' : (SITE_VARIANT === 'finance' ? '#' : 'https://finance.worldmonitor.snakeg0d.com')}"
          ...
          <a href="https://x.com/snakeg0d" target="_blank" rel="noopener" class="credit-link">
            <svg class="x-logo" width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
            <span class="credit-text">@snakeg0d</span>
          </a>
          <a href="https://github.com/snakeg0d/worldmonitor" target="_blank" rel="noopener" class="github-link" title="${t('header.viewOnGitHub')}">
